...
// ? Wawi: qesesto
// ! Pavéz: tu mamá
// ! Pavéz: mentira esto no es tan gordo
// ? Wawi: XDDDDD
// ! Pavéz: es para usar interfaces y poner JSDoc, pa que haya textos, aun que eso no lo hare yo zzzz
...
export interface ReverseTextEndpointResponse
  extends DiscordEmojiEndpointResponse {}
...
export interface PeriodicTableEndpointResponse
  extends DiscordAPIEndpointResponse {}
